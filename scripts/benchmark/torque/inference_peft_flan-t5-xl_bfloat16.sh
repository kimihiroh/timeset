...
dirpath_model=None
peft_model_path=/usr1/datasets/kimihiro/llm-for-event-temporal-ordering/models/torque/flan-t5-xl_bfloat16_peft_generation/seed7_bs8_lr0.0001_dim64_alpha64_drop0.1
