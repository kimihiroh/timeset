...
dirpath_model=None
peft_model_path=/usr1/datasets/kimihiro/llm-for-event-temporal-ordering/models/tddiscourse/deberta-v3-large_bfloat16_peft_sequence_classification/seed7_bs8_lr0.0001_dim64_alpha16_drop0.1
